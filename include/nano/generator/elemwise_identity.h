...
namespace nano
{
    ...
    public:
        ...
        explicit sclass_identity_t(const dataset_t& dataset);
    ...
    public:
        ...
        explicit mclass_identity_t(const dataset_t& dataset);
    ...
    public:
        ...
        explicit scalar_identity_t(const dataset_t& dataset);
    ...
    public:
        ...
        explicit struct_identity_t(const dataset_t& dataset);

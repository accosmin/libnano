...
scalar_elemwise_generator_t::scalar_elemwise_generator_t(
    ...
    generator_t(dataset, samples)
{
    const auto mapping = select_scalar_components(dataset, s2s, feature_indices);
...
tensor_size_t scalar_elemwise_generator_t::features() const
{
    return m_mapping.size<0>();
}

feature_t scalar_elemwise_generator_t::feature(tensor_size_t ifeature) const
{
...
tensor_size_t scalar_pairwise_generator_t::features() const
{
    return m_mapping.size<0>();
}

feature_t scalar_pairwise_generator_t::feature(tensor_size_t ifeature) const
{
    assert(ifeature >= 0 && ifeature < m_mapping.size<0>());

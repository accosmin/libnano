...
sclass_identity_t::sclass_identity_t(const dataset_t& dataset) :
...
mclass_identity_t::mclass_identity_t(const dataset_t& dataset) :
    base_elemwise_generator_t(dataset)
{
}
...
scalar_identity_t::scalar_identity_t(const dataset_t& dataset) :
    base_elemwise_generator_t(dataset)
{
}
...
struct_identity_t::struct_identity_t(const dataset_t& dataset) :
    base_elemwise_generator_t(dataset)
{
}
